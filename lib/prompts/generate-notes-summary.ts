...
export const generateNotesSummaryPrompts: Record<string, PromptDefined> = {
  es: {
    system: teacherPrompts.es,
    user:
      'Tu tarea es crear un resumen de una parte del tema. ' +
      'Te darán el tema general y la parte específica que tienes que resumir junto con una descripción de esta parte. ' +
      ...
      '\n\n\n' +
      'Tema general: {topic}\n\nParte que se debe resumir: {part}\n\nDescripción de la parte a resumir: {description}\n\n',
  },
  en: {
    system: teacherPrompts.en,
    user:
      'Your task is to create a summary of a part of the topic. ' +
      'You will be given the general topic and the specific part to summarize along with a description of what you should include in the summary. ' +
      ...
      'You should use bullet points, subheadings, tables, and mind maps (Mermaid) to organize the summary and add variety. For the most important concepts, ' +
      ...
      '\n\n\n' +
      'General theme: {topic}\n\nPart that should be summarized: {part}\n\nDescription of the part to summarize: {description}\n\n',
  },
};
